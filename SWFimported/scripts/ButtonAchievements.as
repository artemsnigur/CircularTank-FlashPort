package
{
   ...
   public class ButtonAchievements extends MovieClip
   {
      ...
      private var theText:String = "Achievements";
      
      public function ButtonAchievements()
      {
         super();
         ...
         if(Main.changeScreen != "Achievements" && (Main.changeScreen != "Premium" || !ScreenPremium.triggeredFromMenu))
         {
            this.isActive = true;
         }
         else
      ...
      internal function onReleaseHandler(myEvent:MouseEvent) : *
      {
         if(this.isActive && this.pressed)
         {
            ...
            this.gotoAndStop(2);
            Main.changeScreen = "Achievements";
         }
      }
