package
{
   ...
   public class ButtonOptions extends MovieClip
   {
      ...
      private var theText:String = "Options";
      ...
      public function ButtonOptions()
      {
         ...
         if(Main.changeScreen != "Options" && (Main.changeScreen != "Premium" || !ScreenPremium.triggeredFromMenu))
         {
            this.isActive = true;
         }
         else
