package
{
   ...
   public class ButtonUpgrade extends MovieClip
   {
      ...
      public function update(event:Event) : void
      {
         ...
         {
            if(ScreenUpgrades.selectedMisc != 0 && ScreenUpgrades.levelsArrayMisc[ScreenUpgrades.selectedMisc - 1] == ScreenUpgrades.levelsMaxArrayMisc[ScreenUpgrades.selectedMisc - 1])
            {
               this.maxed = true;
            }
            if(ScreenUpgrades.selectedMisc != 0 && ScreenUpgrades.money >= ScreenUpgrades.upgradeArraysArray1[ScreenUpgrades.selectedMisc - 1][0][ScreenUpgrades.levelsArrayMisc[ScreenUpgrades.selectedMisc - 1]])
            {
               this.canAfford = true;
            }
         }
         ...
         {
            if(ScreenUpgrades.selectedWeapon != 0 && ScreenUpgrades.levelsArray[ScreenUpgrades.selectedWeapon - 1] == ScreenUpgrades.levelsMaxArray[ScreenUpgrades.selectedWeapon - 1])
            {
               this.maxed = true;
            }
            if(ScreenUpgrades.selectedWeapon != 0 && ScreenUpgrades.money >= ScreenUpgrades.upgradeArraysArray2[ScreenUpgrades.selectedWeapon - 1][0][ScreenUpgrades.levelsArray[ScreenUpgrades.selectedWeapon - 1]])
            {
               this.canAfford = true;
            }
         }
         ...
         {
            if(ScreenUpgrades.selectedSecondary != 0 && ScreenUpgrades.levelsArraySecondary[ScreenUpgrades.selectedSecondary - 1] == ScreenUpgrades.levelsMaxArraySecondary[ScreenUpgrades.selectedSecondary - 1])
            {
               this.maxed = true;
            }
            if(ScreenUpgrades.selectedSecondary != 0 && ScreenUpgrades.money >= ScreenUpgrades.upgradeArraysArray3[ScreenUpgrades.selectedSecondary - 1][0][ScreenUpgrades.levelsArraySecondary[ScreenUpgrades.selectedSecondary - 1]])
            {
               this.canAfford = true;
            }
         }
      ...
      {
         if(!this.maxed && this.buttonReloadTime == 0)
         {
            if(this.canAfford)
            {
               this.gotoAndStop(3);
      ...
      internal function onReleaseHandler(myEvent:MouseEvent) : *
      {
         ...
         var upgradeLevel:Number = NaN;
         if(!this.maxed && this.buttonReloadTime == 0 && this.pressed)
         {
            if(this.canAfford)
            {
               ...
               if(ScreenUpgrades.upgradeType == 1)
               {
                  ...
                  upgradeLevel = Number(ScreenUpgrades.levelsArrayMisc[ScreenUpgrades.selectedMisc - 1]);
               }
               else if(ScreenUpgrades.upgradeType == 2)
               {
                  upgradeType = "Primary";
                  ...
                  upgradeLevel = Number(ScreenUpgrades.levelsArray[ScreenUpgrades.selectedWeapon - 1]);
               }
               else if(ScreenUpgrades.upgradeType == 3)
               {
                  ...
                  upgradeLevel = Number(ScreenUpgrades.levelsArraySecondary[ScreenUpgrades.selectedSecondary - 1]);
               }
               GameTracker.api.alert(upgradeName + " upgraded to level " + upgradeLevel);
               Main.googleTracker.trackEvent(upgradeType + " Upgraded",upgradeName,"Level " + upgradeLevel);
               SaveManager.saveUpgrades();
               this.buttonReloadTime = this.buttonReloadTimeMax;
               ScreenUpgrades.setTempVar("tempPrimaryWeaponsMaxed");
               ScreenUpgrades.setTempVar("tempSecondaryWeaponsMaxed");
            }
         }
      }
