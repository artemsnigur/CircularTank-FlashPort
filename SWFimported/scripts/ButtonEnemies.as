package
{
   ...
   public class ButtonEnemies extends MovieClip
   {
      ...
      private var theText:String = "Enemies";
      
      public function ButtonEnemies()
      {
         super();
         ...
         if(Main.changeScreen != "Enemies" && (Main.changeScreen != "Premium" || !ScreenPremium.triggeredFromMenu))
         {
            this.isActive = true;
         }
         else
