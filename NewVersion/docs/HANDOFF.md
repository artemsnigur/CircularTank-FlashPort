...
| Item | Needs |
|---|---|
| **`Objective` panel overlaps the HUD** | Bottom-anchored correctly against the AS3's stage, which had no HUD there. Small; a constants-that-became-variables case, not taste. My suggested next task. |
